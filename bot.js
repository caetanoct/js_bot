...
client.on("message", message => {
  ...
  if (message.content === prefix + "guedesepolitica") {
    message.channel.send(
      "Guedes define sua posição política como cristao consevador de direita neoliberal neopentecostal."
    );
  }
  ...
  if (message.content === prefix + "isa") {
    message.channel.send("Olá, eu sou a isa e sou melhor que o caiado no CS");
  }
